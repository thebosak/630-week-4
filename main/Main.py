...
connection.execute('''INSERT INTO Experiment (ResearcherID, Experiment) VALUES ('5','Strange sickness')''')
crsr = connection.cursor()
crsr.execute('SELECT P.Name, E.Experiment FROM People AS P JOIN Experiment AS E WHERE E.ResearcherID == P.PersonID order by E.Experiment')
rows = crsr.fetchall()
